...
public class VistaClienteA extends JFrame implements ActionListener {
    private List<JPanel> jPanelList;
    private List<JLabel> jLabelList;
    private List<JTextField> jtextFieldList;
    private List<JButton> jButtonList;
    private ClienteControl clienteControl;
    public VistaClienteA(String title){
        super(title);
     ...
     public void iniciarEtiquetas(){
       ...
       this.jLabelList.get(0).setText("Ingrese el código de cliente: "); 
       this.jLabelList.get(1).setText("Ingrese los nombres: ");
       this.jLabelList.get(2).setText("Ingrese los apellidos: ");
       this.jLabelList.get(3).setText("Ingrese la fecha de Pedidos: AAAA/MM/DD");
    ...
    public void actionPerformed(ActionEvent e) {
     if(e.getSource().equals(this.jButtonList.get(0))){
        ...
        if(e.getSource().equals(this.jButtonList.get(1))){
            for(Cliente c: this.clienteControl.listar())
